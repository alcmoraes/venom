...
var ListenerLayer = /** @class */ (function (_super) {
  ...
  ListenerLayer.prototype.onMessage = function (fn) {
    this.page.exposeFunction(exposed_enum_1.ExposedFn.OnMessage, function (
      message
    ) {
      return fn(message);
    });
  ...
  ListenerLayer.prototype.onAnyMessage = function (fn) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        this.page
          .exposeFunction(exposed_enum_1.ExposedFn.OnAnyMessage, function (
            message
          ) {
            return fn(message);
          })
  ...
  ListenerLayer.prototype.onStateChange = function (fn) {
    ...
    this.page
      ...
      .then(function () {
        return _this.page.evaluate(function () {
          WAPI.onStateChange(function (_) {
            return window['onStateChange'](_.state);
          });
        });
      });
  };
  ...
  ListenerLayer.prototype.onAck = function (fn) {
    this.page.exposeFunction(exposed_enum_1.ExposedFn.onAck, function (ack) {
      return fn(ack);
    });
  };
  /**
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        return [
          2 /*return*/,
          this.page
            .exposeFunction(method, function (chat) {
              return fn(chat);
            })
            .then(function (_) {
              return _this.page.evaluate(function () {
