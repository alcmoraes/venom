...
var SenderLayer = /** @class */ (function (_super) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              helpers_1.dowloadFileImgHttp(path, [
                'image/png',
                'image/jpg',
                'image/webp',
                'image/gif',
   ...
   * @param caption
   */
  SenderLayer.prototype.sendImageFromBase64 = function (
    to,
    base64,
    filename,
    caption
   ...
   * @param chatId
   */
  SenderLayer.prototype.sendMessageWithThumb = function (
    thumb,
    url,
    title,
    description,
            ...
            return [
              ...
              this.page.evaluate(
                function (_a) {
                  var to = _a.to,
                    content = _a.content,
                    quotedMsg = _a.quotedMsg,
                    mentioned = _a.mentioned;
   ...
   * @param caption
   */
  SenderLayer.prototype.sendPttFromBase64 = function (
    to,
    base64,
    filename,
    caption
   ...
   * @param caption
   */
  SenderLayer.prototype.sendFileFromBase64 = function (
    to,
    base64,
    filename,
    caption
   ...
   */
  SenderLayer.prototype.sendVideoAsGif = function (
    to,
    path,
    filename,
    caption
   ...
   * @param caption string xxxxx
   */
  SenderLayer.prototype.sendVideoAsGifFromBase64 = function (
    to,
    base64,
    filename,
    caption
   ...
   */
  SenderLayer.prototype.forwardMessages = function (
    to,
    messages,
    skipMyMessages
  ) {
          ...
          this.page.evaluate(
            function (_a) {
              var to = _a.to,
                ...
                skipMyMessages = _a.skipMyMessages;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              helpers_1.dowloadFileImgHttp(path, ['image/gif']),
            ];
          case 1:
            b64 = _a.sent();
   ...
   */
  SenderLayer.prototype.sendLocation = function (
    to,
    latitude,
    longitude,
    title,
