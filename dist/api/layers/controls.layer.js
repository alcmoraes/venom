...
var ControlsLayer = /** @class */ (function (_super) {
      ...
      return __generator(this, function (_a) {
        return [
          ...
          this.page.evaluate(function (contactId) {
            return WAPI.unblockContact(contactId);
          }, contactId),
        ];
      });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.page.evaluate(function (contactId) {
            return WAPI.blockContact(contactId);
          }, contactId),
        ];
      });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.page.evaluate(function (contactId) {
            return WAPI.markUnseenMessage(contactId);
          }, contactId),
        ];
      });
    });
      ...
      return __generator(this, function (_a) {
        return [
          ...
          this.page.evaluate(function (chatId) {
            return WAPI.deleteConversation(chatId);
          }, chatId),
        ];
      });
    });
   ...
   * @returns boolean
   */
  ControlsLayer.prototype.pinChat = function (chatId, option) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
   ...
   */
  ControlsLayer.prototype.deleteMessage = function (
    chatId,
    messageId,
    onlyLocal
  ) {
