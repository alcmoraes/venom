  ...
  GroupLayer.prototype.leaveGroup = function (groupId) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.page.evaluate(function (groupId) {
            return WAPI.leaveGroup(groupId);
          }, groupId),
        ];
      });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.page.evaluate(function (groupId) {
            return WAPI.getGroupParticipantIDs(groupId);
          }, groupId),
        ];
      });
    });
  ...
  GroupLayer.prototype.getGroupMembers = function (groupId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getGroupMembersIds(groupId)];
          case 1:
            membersIds = _a.sent();
          ...
          case 0:
            return [
              ...
              this.page.evaluate(function (chatId) {
                return WAPI.getGroupInviteLink(chatId);
              }, chatId),
            ];
          case 1:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.page.evaluate(function (inviteCode) {
                return WAPI.getGroupInfoFromInviteLink(inviteCode);
              }, inviteCode),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
              ...
              this.page.evaluate(
                function (_a) {
                  var groupId = _a.groupId,
                    participantId = _a.participantId;
        ...
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.page.evaluate(function (chatId) {
                return WAPI.getGroupAdmins(chatId);
              }, chatId),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.page.evaluate(function (inviteCode) {
                return WAPI.joinGroup(inviteCode);
              }, inviteCode),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
