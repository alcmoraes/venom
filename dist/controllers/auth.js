...
exports.isAuthenticated = function (waPage) {
  return rxjs_1
    .merge(exports.needsToScan(waPage), exports.isInsideChat(waPage))
...
function decodeQR(page) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, page.waitForSelector('canvas', { timeout: 0 })];
        case 1:
          _a.sent();
          return [
            4 /*yield*/,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          if (!jsonToken) return [2 /*return*/];
          return [
            4 /*yield*/,
            page.evaluateOnNewDocument(function (session) {
              localStorage.clear();
