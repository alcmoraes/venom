...
function initWhatsapp(session, options) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, initBrowser(options)];
        case 1:
          browser = _a.sent();
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            waPage.goto(puppeteer_config_1.puppeteerConfig.whatsappUrl),
          ];
        case 5:
          _a.sent();
 ...
 * @param session
 */
function initBrowser(options, extras) {
  if (extras === void 0) {
    extras = {};
  }
  return __awaiter(this, void 0, void 0, function () {
      ...
      switch (_a.label) {
        case 0:
          if (options.useChrome) {
            ...
            if (chromePath) {
              extras = __assign(__assign({}, extras), {
              ...
              __assign(
                {
                  ...
                  args: options.browserArgs
                    ? options.browserArgs
                    : __spreadArrays(
                        puppeteer_config_1.puppeteerConfig.chroniumArgs
                      ),
                },
                extras
              )
